...
<body class="overflow-x-hidden antialiased">
    ...
    <!-- BEGIN FEATURES SECTION -->
        ...
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <h3
                class="center max-w-2xl items-center px-7 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl">
                {{ __('Bienvenido a nuestro sitio web, conoce nuestros productos!') }}
                <br> <div style="color: white;"> {{ Auth::user()->name }}</div></h3>
